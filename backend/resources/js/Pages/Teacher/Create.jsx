                    ...
                    <div className="bg-white rounded-2xl shadow-lg p-6 md:p-8">
                        ...
                        <div className="mb-6 p-4 bg-indigo-50 rounded-xl border border-indigo-200">
                            ...
                            <div className="flex flex-wrap gap-3">
                                ...
                                <button
                                    ...
                                    disabled={generating}
                                    className="px-5 py-2 rounded-full font-medium text-white bg-indigo-600 hover:bg-indigo-700 transition shadow disabled:opacity-50 disabled:cursor-not-allowed"
                                >
                        ...
                        <form onSubmit={submit} className="space-y-4">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        required
                                    />
                                    {errors.option1 && <p className="text-sm text-red-600 mt-1">{errors.option1}</p>}
                                </div>
                                <div>
                                    ...
                                    <input
                                        ...
                                        required
                                    />
                                    {errors.option2 && <p className="text-sm text-red-600 mt-1">{errors.option2}</p>}
                                </div>
                                <div>
                                    ...
                                    <input
                                        ...
                                        required
                                    />
                                    {errors.option3 && <p className="text-sm text-red-600 mt-1">{errors.option3}</p>}
                                </div>
                                <div>
                                    ...
                                    <input
                                        type="text"
                                        value={data.option4}
                                        onChange={(e) => setData('option4', e.target.value)}
                                        className="mt-1 w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-indigo-500"
                                        required
                                    />
                                    {errors.option4 && <p className="text-sm text-red-600 mt-1">{errors.option4}</p>}
                                </div>
                            </div>
                            ...
                            <div className="flex space-x-3">
                                ...
                                <Link
                                    href={route('teacher.questions', course.id)}
